...
class _EnigmaScreenState extends State<EnigmaScreen> with SingleTickerProviderStateMixin {
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: const Text(
              'Recarregar',
              style: TextStyle(color: darkBackground, fontWeight: FontWeight.bold),
            ),
          ),
        ],
      ),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                ...
                elevation: 0,
                side: BorderSide(
                  color: _isNear && !_isBlocked ? Colors.transparent : Colors.white10,
                ),
              ),
            ),
          ),
