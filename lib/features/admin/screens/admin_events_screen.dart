                ...
                return ListTile(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      ...
                      IconButton(icon: const Icon(Icons.delete, size: 18, color: Colors.red), onPressed: () => ParseCloudFunction('deleteEnigma').execute(parameters: {'eventId': eventId, 'phaseId': phaseId, 'enigmaId': doc.objectId!})),
                    ],
                  ),
                );
              }).toList(),
