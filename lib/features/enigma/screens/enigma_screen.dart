...
class _EnigmaScreenState extends State<EnigmaScreen>
  ...
  void _showMediaDialog(BuildContext context, {required String type, required String url}) {
    showDialog(
      context: context,
        ...
        children: [
          ...
          Container(
            ...
            child: IconButton(
              iconSize: 48,
              color: Colors.orangeAccent,
              icon: FaIcon(_isPlaying ? FontAwesomeIcons.pause : FontAwesomeIcons.play),
              onPressed: () async {
                if (_isPlaying) {
