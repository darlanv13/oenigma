...
class _EventCardState extends State<EventCard> {
        ...
        child: ClipRRect(
          ...
          child: Stack(
            ...
            children: [
              ...
              // Gradiente para informações inferiores
              Positioned.fill(
                child: Container(
                  decoration: BoxDecoration(
  ...
  // NOVO WIDGET PARA O OVERLAY DE FINALIZADO
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if (event.winnerName != null && event.winnerName!.isNotEmpty)
                  Column(
                    children: [
                      const Text(
                        "Vencedor",
  ...
  // WIDGET PARA O OVERLAY DE "EM BREVE"
